    ...
    <div className="site">
      ...
      <main>
        <article className="case-study">
          ...
          <h2>Overview</h2>
          <p>
            A mobile-first learning tool for the periodic table, rebuilt from an earlier project
            after studying User Experience Design (UX). The app offers two modes, flashcards with
          ...
          <p>You can see the original version below.</p>
          <img
            src="/periodic-table-original.png"
            alt="Screenshot of the original periodic table quiz, showing unstyled buttons and basic layout"
          />
          <p>
          ...
          <p>
            ...
            as you clicked through, with no sense of where you were in the sequence. There was no
            way to test yourself, only to reveal answers. The interface gave no feedback and asked
            nothing of the user. It worked as a prototype, but not as a product.
          </p>

          <h2>The process</h2>
          <p>
            I started in Figma rather than code. I defined a clear v1 scope, two modes, mobile
            first, no feature creep, and built a design system first: colour styles, text styles,
            and a consistent component approach. Accessibility was checked at the design stage using
            the Stark plugin, which caught a contrast failure on the primary button colour before it
          ...
          <img
            ...
            alt="Screenshot of the redesigned Periodic Table app showing mode select screen with Flashcard and Quiz options"
          />
          ...
          <p>
            I also noticed that even with a design in place, implementation reveals things the
            design doesn't anticipate. The rating buttons were not in the original Figma when the
            Revealed screen was first designed. They emerged from thinking through the flow during
            development. The design was updated to reflect the real behaviour before the code was
            merged.
          </p>
